...
==============================================================================*/
-- in yerine = olmaz cunki = bir adet veri icin kullanilir
...
==============================================================================*/   
 ...
 select marka_isim, calisan_sayisi, (select SUM(maas) from calisanlar
									where markalar.marka_isim=calisanlar.isyeri)
from markalar;							
                      -- VEYA--
...
/* -----------------------------------------------------------------------------
 ...
 (select round(AVG(maas)) from calisanlar where marka_isim=isyeri) ort_maas
 from markalar;
...
/* -----------------------------------------------------------------------------
 ...
 /*///my solution mua
 /// SELECT marka_isim, calisan_sayisi, 
 (SELECT MAX(maas) from calisanlar where marka_isim=isyeri) as MAXIMUM,
 (SELECT min(maas) from calisanlar where marka_isim=isyeri) as MINIMUM
 FROM markalar;*/
