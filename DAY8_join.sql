...
/*============================== JOIN İSLEMLERİ ===============================
    ...
    2) LEFT JOIN:  Ilk tabloda (Sol) olan sonuclari sonuclari gosterir
    3) RIGHT JOIN: Sadece Ikinci tabloda (sağ) olan tum sonuclari gosterir
       fullL JOIN=(left join + union  + right join) Tablodaki tum sonuclari gosterir
==============================================================================*/   
...
-- baglama isi join lerde on keyword ü ile yapilir
